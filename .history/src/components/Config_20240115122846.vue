...
<script>
import { IonButton, IonButtons, IonContent, IonHeader, IonModal, IonTitle, IonToolbar, IonItemGroup ,IonItem, IonItemDivider, IonLabel, IonButtons, IonThumbnail, IonModal, IonList,} from '@ionic/vue';
