<template>
  <ion-grid>
    <ion-row class="my-item-group">
      ...
      <ion-col size="1.5" class="my-item-dec"><ion-button fill="clear" @click="decrement">-</ion-button></ion-col>
      <ion-col size="1.5">{{ count }}</ion-col>
      <ion-col size="1.5"><ion-button fill="outline" color="dark" @click="increment">+</ion-button></ion-col>
...
ion-col > ion-button > button{
  ...
  width:100%;
  adding-inline-start: var(--padding-start); */
