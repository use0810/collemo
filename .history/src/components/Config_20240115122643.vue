...
<script>
import { IonButton, IonButtons, IonContent, IonHeader, IonModal, IonTitle, IonToolbar, IonItemGroup ,IonItem, IonItemDivider, IonLabel, IonButtons,ion-thumbnail} from '@ionic/vue';
