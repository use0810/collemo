...
export default defineComponent({
  ...
  const contents = await Filesystem.readFile({
    ...
    console.log("contens.valueの中身"+JSON.parse(contents.data_rawvalue).value)
    console.log("dataは取得できる？"+contents.data.value);
    console.log("listは取得できる？"+contents.data._rawvalue);
