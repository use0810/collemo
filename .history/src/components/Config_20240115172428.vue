<template>
  ...
  <ion-modal :is-open="isOpen" @ionBackdropClick="setOpen(false)"">
    <!-- ここからモーダルのヘッダー部分 -->
    <ion-header>
      <ion-toolbar>
...
import { IonButton, IonButtons, IonContent, IonHeader, IonModal, IonTitle, IonToolbar,   IonLabel} from '@ionic/vue';
