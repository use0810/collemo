<template>
  <ion-grid>
    <ion-row class="my-item-group">
      ...
      <ion-col size="1.5" class="my-item-dec"><ion-button size="small" fill="outline" color="dark" @click="decrement">-</ion-button></ion-col>
      <ion-col size="1.5">{{ count }}</ion-col>
      <ion-col size="1.5"><ion-button size="small" fill="outline" color="dark" @click="increment">+</ion-button></ion-col>
