...
import FileManage from '/src/module/DrawTable.js';
...
export default defineComponent({
  ...
  setup() {
    ...
    const reflection = async(file) => {
      ...
      await FileManage.writeFile(filePath, png);
      const dataPath = await FileManage.getDataPath(filePath);
      // alert(dataPath)
      await Share.share({
      ...
      // await FileManage.deleteFile('temp');
